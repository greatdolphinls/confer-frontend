    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          have been made aware of and to have accepted, the changes in any revised Terms of Use by your continued
      ...
      <div className={classes.container}>
        ...
        <ul>
          ...
          <li>
            ...
            he use of the Site and/or the Content contained therein.
          </li>
          <li>
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          and through third-party websites. As such, any Contributions you transmit may be treated
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          and distribute such Contributions (including, without limitation, your image and voice) for any purpose,
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          property rights, and shall be entitled to the unrestricted use and dissemination of these Submissions
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          (for computer software) and FAR 12.211 (for technical data). If our services are acquired by or
          on behalf of any agency within the Department of Defense, our services are subject to the
          terms of these Terms of Use in accordance with Defense Federal Acquisition Regulation (“DFARS”) 227.72023.
          In addition, DFARS 252.2277015 applies to technical data acquired by the DOD. This U.S. Government Rights
          clause is in lieu of, and supersedes, any other FAR, DFARS, or other clause or provision that addresses
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          our systems; and (5) otherwise manage the Site in a manner designed to protect our rights and property
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          <b>https://hellomerit.com/privacy</b>. By using the Site, you agree to be bound by our Privacy Policy,
          which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States.
          ...
          requisite and verifiable parental consent, we will delete that information from the Site as quickly as
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY
          APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE YOUR
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          or errors. We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify
          the Site at any time or for any reason without notice to you. You agree that we have no liability
      ...
      <div className={classes.container}>
        ...
        <div className={classes.container}>
          ...
          <Typography className={classes.mainDescription}>
            ...
            the applicable AAA rules or applicable law, the arbitration will take place in New York County.
          ...
          <Typography className={classes.mainDescription}>
            ...
            or prosecuted in the state and federal courts located in New York County, and the Parties
            ...
            Nations Convention on Contracts for the International Sale of Goods and the the Uniform Computer
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SITE, (5) ANY BUGS, VIRUSES,
          TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6)
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW
  ...
  const californiaRender = () => {
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance U
          nit of the Division of Consumer Services of the California Department of Consumer Affairs in writing
          at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210
          or (916) 445-1254.
        </Typography>
      </div>
    )
    ...
    return (
      <div className={classes.container}>
        ...
        <Typography className={classes.mainDescription}>
          ...
          waiver of such right or provision. These Terms of Use operate to the fullest extent permissible
          ...
          deemed severable from these Terms of Use and does not affect the validity and enforceability
          of any remaining provisions. There is no joint venture, partnership, employment or agency
